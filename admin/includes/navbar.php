<header class="main-header">
  ...
  <a href="home.php" class="logo">
    ...
    <span class="logo-mini"><img src="../images/logo.png" width="50px" style="background-color: white"></span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><img src="../images/logo.png" width="120px" style="background-color: white"></span>
  </a>
