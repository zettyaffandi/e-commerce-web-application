              ...
              <form class="form-horizontal" method="POST" action="products_edit.php">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                   ...
                   <label for="edit_category" class="col-sm-1 control-label">Availability</label>

                  <div class="col-sm-5">
                    <select class="form-control" id="edit_avail" name="availability">
                      <option id="availselected"></option>
